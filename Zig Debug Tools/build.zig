...
pub fn build(b: *std.Build) !void {
    ...
    const elf_check = b.addExecutable(.{
        .name = "CHECK",
        .root_source_file = b.path("src/main.zig"),
        .target = playdate_target,
        .optimize = optimize,
...
fn compile_simulator_binary(
    ...
    // DEBUG TOOLS CHANGE: adding imgui dependencies to the simulator binary only
    {
        ...
        { // Needed for glfw/wgpu rendering backend
            ...
            lib.linkLibrary(zopengl.artifact("zopengl"));
        }
    }
